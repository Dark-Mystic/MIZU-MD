...
cmd({
    ...
    async(Void, citel) => {
        ...
        let cap = `*🌐 𝗠𝗜𝗭𝗨-𝗠𝗗 _𝗢𝗙𝗙𝗜𝗖𝗜𝗔𝗟 ♦️*

●. *Support group :* https://chat.whatsapp.com/Caxl90g1F2FHnlHEfsJTL3

●. *Developer:* https://wa.me/+923474187615

ᴍɪᴢᴜ-ᴍᴅ ⦁ ᴍᴀᴅᴇ ʙʏ ᴀsɪғ ᴋʜᴀɴ
ʀᴇʟᴇᴀsᴇᴅ ⦁ 𝟸𝟶𝟸𝟹/𝟶𝟷/𝟶𝟸
`
        let buttonMessaged = {
...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            let buttons = [{
                    ...
                    buttonId: `${prefix}promote 923474187615`,
