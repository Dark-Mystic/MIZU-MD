...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://i.ibb.co/s2H1yKk/Mizu.jpg'
module.exports = {
  ...
  alivepic: process.env.ALIVE_IMG || 'https://i.ibb.co/s2H1yKk/Mizu.jpg',
  alivemsj: process.env.ALIVE_MSJ || '*The bot developer is Asif* 🎊',
  ...
  LANG: process.env.THEME|| 'MIZU-MD',
